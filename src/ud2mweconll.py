...
fixedmwes = ["mwe","name"]
freemwes= ["compound:prt",'aux',"compound"]
    ...
    for component in nx.connected_components(auxgraph):
        if is_well_formed_span(component): #if it is well-formed we can treat is as a fixed continuous MWE
            ...
            for n in component[1:]:
                ...
                mwe_label = "mwe_" + most_common_label_filler[former_label_of_n]
            ...
            for n in component:
                ...
                outsent.add_edge(h,n, { "deprel" : 'nsubj'})
    ...
    for h,d in sent.edges():
        if sent[h][d]["deprel"] in freemwes:
            ...
            if type(overall_mwe_function) == str:
                if "_rmwe_" in overall_mwe_function or overall_mwe_function.startswith("mwe"):
                    pass
                else:
...
def main():
    ...
    parser.add_argument('--trainfile', help="conllu file",default="/Users/hmartine/data/UD1.3/ud-treebanks-v1.3/UD_French/fr-ud-train.conllu")
    parser.add_argument('--input', help="conllu file",default="/Users/hmartine/data/UD1.3/ud-treebanks-v1.3/UD_French/fr-ud-dev.conllu")
    ...
    for s in orig_treebank:
        s1 = flatten_mwe_chains(s,most_common_label_filler)
